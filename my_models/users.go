...
var UserWhere = struct {
	...
	Passwd:     whereHelperstring{field: "`users`.`passwd`"},
	CreateDate: whereHelpernull_Time{field: "`users`.`create_date`"},
}
...
var (
	userAllColumns            = []string{"id", "username", "passwd", "create_date"}
	userColumnsWithoutDefault = []string{"username", "passwd", "create_date"}
