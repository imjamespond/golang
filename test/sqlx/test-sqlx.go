...
func main() {
	...
	db, err := sqlx.Connect("mysql", "root:dataSharing@tcp(192.168.0.247:32495)/gorm?charset=utf8mb4&parseTime=True&loc=Local")
	if err != nil {
		log.Fatalln(err)
	}
	...
	fmt.Printf("usa, singsing, honkers: \n%#v\n%#v\n%#v\n", usa, singsing, honkers)
